...
export const authApi = {
  register: (dto : RegisterDto) => request<void>("/auth/register", {
    method: "POST",
    body: dto,
    auth: false
  }),
  ...
  requestPasswordReset: (email : string) => request<void>("/auth/request-reset", {
    method: "POST",
    body: {
      email
    },
  ...
  resetPassword: (token : string, new_password : string) => request<void>("/auth/reset-password", {
    method: "POST",
    body: {
      token,
      new_password
  ...
  changePassword: (dto : ChangePasswordDto) => request<void>("/auth/change-password", {
    method: "POST",
    body: dto
  })
};
