...
export const familiesApi = {
  ...
  update: (id: string, dto: CreateFamilyDto) =>
    request<Family>(`/families/${id}`, {
      method: 'PATCH',
      body: dto,
    }),
  delete: (id: string) => request<void>(`/families/${id}`, { method: 'DELETE' }),
  invite: (id: string, dto: InviteMemberDto) =>
    request<void>(`/families/${id}/members`, {
      method: 'POST',
      body: dto,
    }),
  removeMember: (id: string, userId: string) =>
    request<void>(`/families/${id}/members/${userId}`, { method: 'DELETE' }),
  ...
  getPendingInvites: () => request<FamilyInvite[]>('/invites'),
  ...
  getSentInvites: () => request<FamilyInvite[]>('/invites/sent'),
